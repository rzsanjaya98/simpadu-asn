      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="card-body">
               ...
               <form action="{{ url('/employeeeducation/'.$user_id.'/create') }}" method="POST">
                  @csrf
                  <div class="row">
                     <div class="col-xl-6">
                        <div class="form-group row">
                           ...
                           <div class="col-lg-9">
                              <select class="select" name="education_level">
                                 ...
                                 <option value="Diploma I" {{ old('education_level' ?? '') === 'Diploma I' ? 'selected' : '' }}>Diploma I</option>
                                 <option value="Diploma II" {{ old('education_level' ?? '') === 'Diploma II' ? 'selected' : '' }}>Diploma II</option>
                                 <option value="Diploma III" {{ old('education_level' ?? '') === 'Diploma III' ? 'selected' : '' }}>Diploma III</option>
                                 <option value="Diploma IV" {{ old('education_level' ?? '') === 'Diploma IV' ? 'selected' : '' }}>Diploma IV</option>
                                 <option value="Sarjana (S1)" {{ old('education_level' ?? '') === 'Sarjana (S1)' ? 'selected' : '' }}>Sarjana (S1)</option>
                                 <option value="Magister (S2)" {{ old('education_level' ?? '') === 'Magister (S2)' ? 'selected' : '' }}>Magister (S2)</option>
                                 <option value="Doktor (S3)" {{ old('education_level' ?? '') === 'Doktor (S3)' ? 'selected' : '' }}>Doktor (S3)</option>
                              </select>
                           </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-lg-9">
                              <input type="date" name="graduate" value="{{ old('graduate') }}" class="form-control">
                           </div>
                        </div>
                     </div>
                     <div class="text-end">
