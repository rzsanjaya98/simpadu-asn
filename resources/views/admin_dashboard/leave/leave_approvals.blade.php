                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li>
                                                                    <form id="approve_leader{{ $leave_approval_leaders->leave_request_id }}" action="{{ url('/leave_approval/'.$leave_approval_leaders->leave_request_id.'/leave_approved_leader') }}" method="POST" style="display:none;">
                                                                        @csrf
                                                                        @method('PATCH')                                                
                                                                    </form>
                                                                    <a href="#" class="dropdown-item" onclick="event.preventDefault(); document.getElementById('approve_leader{{ $leave_approval_leaders->leave_request_id }}').submit();"><img src="{{ asset('dashboard_admin/assets/img/icons/thumbs-up.svg')}}" class="me-2" alt="img">Approved</a>        
                                                                </li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                                    ...
                                                                    <form action="{{ url('/leave_approval/'.$leave_approval_leaders->leave_request_id.'/leave_rejected_leader') }}" method="POST">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-12 col-12">
                                                                                <div class="form-group">
                                                                                <label>Catatan</label>
                                                                                <textarea name="leader_note" id="" cols="20" rows="10"></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-12 text-center">
