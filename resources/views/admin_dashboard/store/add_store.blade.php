                ...
                <form action="{{ url('/store/create') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                <label>Lokasi</label>
                                <input type="text" id="lokasi" name="store_location" value="{{ old('store_location') }}">
                            </div>
                            {{-- <div class="form-group">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                <label>Latitude</label>
                                    ...
                                    <input type="text" name="store_latitude" id="latitude" value="{{ old('store_latitude') }}">
                            </div>
                            <div class="form-group">
                                <label>Longitude</label>
                                    {{-- <input type="text" name="longitude" id="longitude" disabled> --}}
                                    <input type="text" name="store_longitude" id="longitude" value="{{ old('store_longitude') }}">
                            </div>
                        </div>
                        <div class="col-lg-12">
